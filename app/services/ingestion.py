...
def fetch_and_store_payment(db: Session, payment_id: str) -> Payment:
    ...
    upserts it into the payments table with its real error_code,
    error_reason, and state.
    """
